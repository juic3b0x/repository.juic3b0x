...
news_file = 'https://raw.githubusercontent.com/Ezra-Hubbard/Ezra-Hubbard.github.io/master/repo/zips/plugin.video.wutu/newsinfo.txt'
local_news = joinPath(wutu_path, 'newsinfo.txt')
